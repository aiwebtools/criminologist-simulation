        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col space-y-8">
            <div>
              ...
              >
                Analyze crime scenes, process evidence, and generate investigative leads with cutting-edge AI tools from AiWebTools.Ai. Discover new insights through pattern recognition and data correlation techniques. Perfect for training, research, and educational scenarios in criminal justice and forensic science.
              </motion.p>
            </div>
            ...
            >
              ...
              >
                <span>Try The Free AI Tool</span>
                <ArrowRight size={18} />
              </CyberButton>
            ...
            >
              {[
                ...
                <div key={index} className="flex flex-col items-center text-center p-3 rounded-lg bg-cyber-dark/50 border border-white/5">
          ...
          >
            <div className="relative aspect-video">
              <iframe 
                src="https://www.youtube.com/embed/iQzgCq-mmtE?autoplay=1&mute=0&controls=1&rel=0&modestbranding=1&hd=1" 
